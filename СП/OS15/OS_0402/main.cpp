...
#define HTPATH L"E:/5sem/СП/OS15/x64/Debug/HTspace.ht"
//#define HTPATH L"../OS15_CREATE/HTspace.ht"
...
int main(int argc, char* argv[])
{
	...
	try
	{
		...
		ht::HtHandle* ht = OS15_HTCOM::HT::open(h, HTPATH, L"HTUser01", L"9900", true);
		if (ht)
